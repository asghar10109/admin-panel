...
import {getFilteredData, getTechnician} from '../utils/helper';
import UserDetails from '../components/dashboard/UserDetails';
import ViewModal from '../components/modal/ViewModal';
import DeleteModal from '../components/modal/DeleteModal';
import {userColumns, userPlansColumns} from '../utils/columns-constants'
            ...
            <div className='pages user-page'>
                <Row>
                    <Col xs={12} className='mb-4'>
                        <h2 className='text-black fw-800'>User Plans</h2>
                    </Col>
                    ...
                    <Col xs={12} className='mt-2'>
                        <div className="table-wrapper">
                            ...
                            <Row className='mt-3'>
                                <ThemeDataTable
                                    columns={userPlansColumns(setIsOpen, dispatch)}
                                    rows={getTechnician(getFilteredData(data?.data, searchText))}
                                    isLoading={isLoading}
                                    setPage={setPage}
